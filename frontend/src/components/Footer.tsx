    ...
    <footer className="bg-[#080808] text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <a
                href="https://www.instagram.com/hotel_aaichyaa_gavat1"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-pink-500/15 hover:bg-pink-500/25 text-pink-400 text-sm font-semibold px-4 py-2 rounded-full transition-colors duration-200"
              >
                <Instagram size={16} />
                Instagram
              </a>
            ...
            <p className="text-white/30 text-xs mt-4">
              &copy; {new Date().getFullYear()} Hotel Aaichyaa Gavat. All rights reserved.
            </p>
          </div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={to}>
                  <Link
                    to={to}
                    className="text-white/60 text-sm hover:text-[#C0272D] transition-all duration-200 hover:translate-x-1 inline-block"
                  >
                    {label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                <Clock size={16} className="text-[#C0272D] flex-shrink-0" />
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-[#C0272D] font-devanagari text-sm font-medium">
